  ...
  return (
    <div className="dropdown dropdown-hover" onMouseEnter={() => setArrow(arrowUp)} onMouseLeave={() => setArrow(arrowDown)}>
      ...
      <div className="dropdown-menu dropdown-menu-bottom-right bg-termi">
        <Link href="/vip/skyblock" className="dropdown-item text-sm hover:bg-gray-500">Pravidla</Link>
        <Link href="/testing" className="dropdown-item text-sm hover:bg-gray-500">Ke stažení</Link>
      </div>
    </div>
  );
};
