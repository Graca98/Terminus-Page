    ...
    <>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">
              VIP výhody na Skyblock serveru
            </h2>
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 lg:gap-6 lg:space-y-0 ">
            ...
            <div className="indicator flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border-2 lg:border-4 border-cyan-400 shadow xl:p-8 lg:scale-105 lg:hover:scale-110 transition ease-in-out duration-300">
              <span className="indicator-item indicator-center badge bg-cyan-400 border-cyan-400 text-white font-semibold py-3 px-4">
                OBLÍBENÉ
              </span>
      ...
      <section>
        <div role="tablist" className="tabs tabs-boxed w-1/2 mx-auto">
          <button onClick={handleTabulku} role="tab" className="tab">
            Tab 1
          </button>
